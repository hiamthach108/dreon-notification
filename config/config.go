...
type AppConfig struct {
	...
	Notification struct {
		...
		ScheduledPollIntervalSec int `env:"NOTIFICATION_SCHEDULED_POLL_INTERVAL_SEC" default:"60"`
		ScheduledBatchSize       int `env:"NOTIFICATION_SCHEDULED_BATCH_SIZE" default:"10"`
		ScheduledDedupTTLSec     int `env:"NOTIFICATION_SCHEDULED_DEDUP_TTL_SEC" default:"86400"`
	}
